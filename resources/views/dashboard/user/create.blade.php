                ...
                <div class="p-6 text-gray-900 dark:text-gray-100 overflow-x-auto">
                    <form action="{{ route('users.store') }}" method="POST">
                        ...
                        <div class="w-full mt-1">
                            ...
                            <x-form.input type="text" name="name" id="name" class="w-full"
                        ...
                        <div class="w-full mt-1">
                            ...
                            <x-form.input type="email" required name="email" id="email" class="w-full" placeholder="Masukkan Email" />
                            <div class="mt-2">
                                @error('email')
                                    <x-form.error :messages="$message" />
                                @enderror
                        ...
                        <div class="w-full mt-1">
                            ...
                            <x-form.input type="password" name="password" id="password" class="w-full" placeholder="Masukkan Kata Sandi" />
                            <div class="mt-2">
                                @error('password')
                                    <x-form.error :messages="$message" />
                                @enderror
